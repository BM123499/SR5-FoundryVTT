...
export const FLAGS = {
    ...
    WallMoveRestriction: 'wallMoveRestriction',
    WallSightRestriction: 'wallSightRestriction',
    WallLightRestriction: 'wallLightRestriction',
    WallSoundRestriction: 'wallSoundRestriction',
    WallSightDefault: 'wallSightDefault',
    WallLightDefault: 'wallLightDefault',
    WallSoundDefault: 'wallSoundDefault',
    WallAstralMove: 'wallAstralMove',
    WallAstralSight: 'wallAstralSight',
    WallAstralLight: 'wallAstralLight',
    WallAstralSound: 'wallAstralSound',
    WallAstralDirection: 'wallAstralDirection',
    WallAstralThresholdSight: 'wallAstralThresholdSight',
    WallAstralThresholdLight: 'wallAstralThresholdLight',
    WallAstralThresholdSound: 'wallAstralThresholdSound',
    WallAstralAttenuation: 'wallAstralAttenuation',
